...
<div id="booking-service-drawer"
    class="fixed top-16 right-2 rounded-lg z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-white w-80 dark:bg-gray-800"
    tabindex="-1" aria-labelledby="drawer-right-label">
    <h5 id="drawer-right-label"
        class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400">
        Address for Service Provide:</h5>
    <button type="button" data-drawer-hide="booking-service-drawer" aria-controls="booking-service-drawer"
