 ...
 @if (session()->has('message'))
     <div x-data="{ show: true }" x-show="show" id="toast-success" x-init="setTimeout(() => show = false, 3000)"
         ...
         <div class="ms-3 text-sm font-normal whitespace-nowrap">{{ session('message') }}</div>
 ...
 @if (session()->has('d_msg'))
     <div x-data="{ show: true }" x-show="show" id="toast-success" x-init="setTimeout(() => show = false, 3000)"
         ...
         <div class="ms-3 text-sm font-normal whitespace-nowrap">{{ session('d_msg') }}</div>
