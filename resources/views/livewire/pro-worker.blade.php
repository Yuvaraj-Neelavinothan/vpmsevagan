<div>
                    ...
                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                                {{ $id_profession ? 'Update ' : 'Add new ' }}Profession
                            </h3>
                        ...
                        <form wire:submit="save">
                            <div class="grid gap-4 mb-4 sm:grid-cols-3">
                                <div>
                                    <label for="code"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profession
                                        Code</label>
                                    <input type="text" wire:model="profession_code"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Type profession code">
                                    @error('profession_code')
                                ...
                                <div>
                                    <label for="name"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profession
                                        Name</label>
                                    <input type="text" wire:model="profession_name"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                ...
                                <div>
                                    <label for="m_price"
                                        ...
                                        Charge</label>
                                    <input type="number" wire:model.live="min_charge" min="0"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="299">
                                    @error('min_charge')
                                        <span class="error text-red-300">{{ $message }}</span>
                                ...
                                <div>
                                    <label for="o_price"
                                        ...
                                        Charge</label>
                                    <input type="number" wire:model="original_charge" min="0"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="299" disabled>
                                </div>
                                <div>
                                ...
                                <div>
                                    <label for="profession_duration"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profession
                                        Duration(min)</label>
                                    <input type="number" wire:model="profession_duration" min="0"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="30">
                                </div>
                                <div>
                                    <label for="description"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profession
                                        Description</label>
                                    <textarea wire:model="profession_description" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Write profession description here"></textarea>
                                </div>
                                ...
                                <div>
                                    <label for="dropzone-file"
                                        ...
                                        @if ($profession_image)
                                            @if (is_string($profession_image))
                                                <img class="rounded-lg"
                                                    src="{{ asset('upload_img/' . $profession_image) }}">
                                            @else
                                                <img class="rounded-lg" src="{{ $profession_image->temporaryUrl() }}">
                                            @endif
                                        @else
                                            <div wire:loading wire:target="profession_image">
                                            ...
                                            <div wire:loading.remove wire:target="profession_image"
                                        ...
                                        @endif
                                        <input wire:model="profession_image" id="dropzone-file" type="file"
                                            class="hidden" />
                                    </label>
                                    @error('profession_image')
                                        <span class="error text-red-300">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
    ...
    @include('status-msg')
    {{-- search,export,record per page and add profession --}}
                ...
                <table class="min-w-[1300px] text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr class="bg-gray-200">
                            ...
                            <th scope="col" class="px-4 py-3">profession name</th>
                            <th scope="col" class="px-4 py-3">description</th>
                            <th scope="col" class="px-4 py-3">min charge</th>
                    ...
                    @php
                        $page = $professions->currentPage();
                        $per_page = $professions->perPage();
                        $sno = ($page - 1) * $per_page + 1;
                    @endphp
                    <tbody>
                        @forelse ($professions as $pro)
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <td class="w-4 px-4 py-3">
                                    {{ $sno++ }}
                                </td>
                                <td class="px-4 py-2">{{ $pro->profession_code }}</td>
                                <th scope="row"
                                    class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <img src="{{ asset('upload_img/' . $pro->profession_image) }}" alt=""
                                        class="w-auto h-7 mr-3 rounded-lg">
                                    {{ $pro->profession_name }}
                                </th>
                                <td class="px-4 py-2">{{ $pro->profession_description }}
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $pro->min_charge }}
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $pro->offer_percentage }}
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $pro->offer_price }}
                                </td>
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ml-1 text-gray-500 dark:text-gray-400">{{ $pro->rating }}</span>
                                    </div>
                                </td>
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ $pro->profession_duration }}
                                </td>
                                <td class="px-4 py-2"><label class="items-center mb-5 cursor-pointer">
                                        <input wire:click="toggle_status({{ $pro->id }})" type="checkbox"
                                            class="sr-only peer" {{ $pro->profession_status == 1 ? 'checked' : '' }}>
                                        <div
                                ...
                                <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div x-data="{ open: false }" class="relative">
                                        ...
                                        <div x-show="open" @click.away="open = false" x-transition
                                            ...
                                            <a wire:click="delete({{ $pro->id }})"
                                                wire:confirm="Are you sure you want to delete this profession Label?"
                                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><svg
