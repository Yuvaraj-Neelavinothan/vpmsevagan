                    ...
                    <div
                        ...
                        <div class="h-56 w-full">
                            <img class="mx-auto h-full dark:hidden rounded-lg"
                                src="{{ asset('upload_img/' . $material->material_image) }}" alt="" />
                        ...
                        <div class="pt-6">
                            <div class="mb-4 flex items-center justify-between gap-4">
                                ...
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <div id="tooltip-quick-look{{ $material->id }}" role="tooltip"
                                    ...
                                    <button type="button"
                                        data-tooltip-target="tooltip-add-to-favorites{{ $material->id }}"
                                        class="rounded-lg p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                                    ...
                                    <div id="tooltip-add-to-favorites{{ $material->id }}" role="tooltip"
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $material->rating }}</p>
